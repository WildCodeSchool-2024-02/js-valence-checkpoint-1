...
const adultWomen = adults.filter(person => person.sex === 'female');
const adultMen = adults.filter(person => person.sex === 'male');
...
console.log("Femme adulte", adultWomen);
console.log("Homme adulte", adultMen);
