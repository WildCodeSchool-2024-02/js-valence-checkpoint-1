...
function isLeapYear(year) {
  const canBeDividedBy4 = year % 4 === 0
  const canBeDividedBy100 = year % 100 === 0
  const canBeDividedBy400 = year % 400 === 0
  return (canBeDividedBy4 && !canBeDividedBy100) || canBeDividedBy400
}
